                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @foreach (\App\Models\Transaction_detail::where('transaction_id', $item->id)->where('order_status', 'Diproses')->get() as $transaction_detail)
                                                            ...
                                                            <p class="text-muted">Pesan : {{ $transaction_detail->note }}
                                                            </p>
                                                    ...
                                                    <td>
                                                        <a href="" data-toggle="modal"
                                                            ...
                                                            style="width: 50px" class="btn btn-success"><i
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header modal-colored-header bg-primary">
                                                                <h4 class="modal-title" id="modal-editLabel">Selesaikan
                                                                    Pesanan
                                                                </h4>
                                                            </div>
                                                            <div class="modal-body">
                                                                <h4 class="px-5 text-center mb-5"><strong>Apakah Akan
                                                                        Menyelesaikan Pesanan?</strong></h4>
                                                                <h1 class="px-5 text-center text-primary "><span
                                                                        class="fas fa-check-circle"></span></strong></h4>

                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary ms-auto"
                                                                    data-bs-dismiss="modal">Batal</button>
                                                                <form action="{{ route('pesanan.update', $item->id) }}"
                                                                    method="POST">
                                                                    @method('PUT')
                                                                    @csrf
